% yildiz_nav_example_allan: example of how to implement the Allan variance 
% procedure with Yildiz_NAV functions.
...
fprintf('\Yildiz_NAV: Allan variance analysis from real IMU STIM300... \n')
...
fprintf('Yildiz_NAV: dataset time span is %.2f hours or %.2f minutes or %.2f seconds. \n\n', (to/60/60), (to/60), to)
...
fprintf('\nYildiz_NAV: Allan variance analysis from synthetic data based on Microstrain 3DM-GX3-35 IMU... \n')
...
fprintf('Yildiz_NAV: generating IMU ACCR synthetic data... \n')

fb = acc_gen (ref, ustrain);   % Generate acc in the body frame
imu.fb = fb;

fprintf('Yildiz_NAV: generating IMU GYRO synthetic data... \n')
