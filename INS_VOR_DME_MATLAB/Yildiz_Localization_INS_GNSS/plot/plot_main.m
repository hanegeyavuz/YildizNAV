function  plot_main (ref, gnss, nav_e, gnss_i, nav_i, ref_g, ref_n, OUTAGE, times_out)
% plot: plots results from INS/GNSS integration dataset.
%
% INPUT
...
if (strcmp(OUTAGE,'ON'))
    ...
    l1 = legend('REF', 'INS/VOR/DME', 'Starting point', 'GNSS outage', 'Location', 'SouthEast');
else
    l1 = legend('REF', 'INS/VOR/DME', 'Starting point', 'Location', 'SouthEast');
end
...
subplot(311)
cell_s = {'ROLL', 'Time [s]', '[deg]', 'REF', 'INS/VOR/DME'};
...
subplot(312)
cell_s = {'PITCH', 'Time [s]', '[deg]', 'REF', 'INS/VOR/DME'};
...
subplot(313)
cell_s = {'YAW', 'Time [s]', '[deg]', 'REF', 'INS/VOR/DME'};
...
% 
% subplot(311)
% cell_s = {'ROLL ERROR', 'Time [s]', '[deg]', '3\sigma', 'INS/VOR/DME'};
...
% 
% subplot(312)
% cell_s = {'PITCH ERROR', 'Time [s]', '[deg]', '3\sigma', 'INS/VOR/DME'};
...
% 
% subplot(313)
% cell_s = {'YAW ERROR', 'Time [s]', '[deg]', '3\sigma', 'INS/VOR/DME'};
...
% 
% subplot(311)
% cell_s = {'NORTH VELOCITY', 'Time [s]', '[m/s]', 'REF', 'GNSS', 'INS/VOR/DME'};
...
% 
% subplot(312)
% cell_s = {'EAST VELOCITY', 'Time [s]', '[m/s]', 'REF', 'GNSS', 'INS/VOR/DME'};
...
% 
% subplot(313)
% cell_s = {'DOWN VELOCITY', 'Time [s]', '[m/s]', 'REF', 'GNSS', 'INS/VOR/DME'};
...
% 
% subplot(311)
% cell_s = {'VELOCITY NORTH ERROR', 'Time [s]', '[m/s]', '3\sigma', 'GNSS', 'INS/VOR/DME'};
...
% 
% subplot(312)
% cell_s = {'VELOCITY EAST ERROR', 'Time [s]', '[m/s]', '3\sigma', 'GNSS', 'INS/VOR/DME'};
...
% 
% subplot(313)
% cell_s = {'VELOCITY DOWN ERROR', 'Time [s]', '[m/s]', '3\sigma', 'GNSS', 'INS/VOR/DME'};
...
subplot(311)
cell_s = {'LATITUDE', 'Time [s]', '[deg]', 'REF', 'GNSS', 'INS/VOR/DME'};
...
subplot(312)
cell_s = {'LONGITUDE', 'Time [s]', '[deg]', 'REF', 'GNSS', 'INS/VOR/DME'};
...
subplot(313)
cell_s = {'ALTITUDE', 'Time [s]', '[deg]', 'REF', 'GNSS', 'INS/VOR/DME'};
...
subplot(311)
cell_s = {'LATITUDE ERROR', 'Time [s]', '[m]', '3\sigma', 'GNSS', 'INS/VOR/DME'};
...
subplot(312)
cell_s = {'LONGITUDE ERROR', 'Time [s]', '[m]', '3\sigma', 'GNSS', 'INS/VOR/DME'};
...
subplot(313)
cell_s = {'ALTITUDE ERROR', 'Time [s]', '[m]', '3\sigma', 'GNSS', 'INS/VOR/DME'};
